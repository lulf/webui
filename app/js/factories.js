...
var module = angular.module('EnMasse.factories', ['ui.bootstrap', 'patternfly.notification']);
...
module.factory('EnMasseAuthService', ['$http', '$cookies', '$rootScope', '$timeout',
    function($http, $cookies, $rootScope, $timeout) {
        ...
        service.SetCredentials = function(username, password) {
            ...
            $cookies.putObject('enmasseokie', $rootScope.globals, {
                'expires': expireDate
            });
        };
