...
var module = angular.module('EnMasse.controllers', [
    'ngAnimate',
    'ui.bootstrap',
...
module.controller('NavCtrl', function($rootScope, $scope, $location, EnMasseAuthService) {
    $scope.isActive = function(route) {
        return $location.path() === route;
    };
    $scope.logout = function() {
//        EnMasseAuthService.ClearCredentials();
//        $location.path('/login');
    };
});
...
module.controller('LoginController', ['$scope', '$rootScope', '$location', 'EnMasseAuthService',
    function($scope, $rootScope, $location, EnMasseAuthService) {
        $scope.username = '';
        $scope.password = '';
        EnMasseAuthService.ClearCredentials();
        $scope.login = function() {
            $scope.dataLoading = true;
            EnMasseAuthService.Login($scope.username, $scope.password, function(response) {
                EnMasseAuthService.ClearCredentials();
                if (response.success) {
                    EnMasseAuthService.SetCredentials($scope.username, $scope.password);
